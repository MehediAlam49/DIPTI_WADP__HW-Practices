...
class EventUserModel(AbstractUser):
    profile_image = models.ImageField(upload_to='media/profile_images',null=True)
...
class EventBookingModel(models.Model):
    ...
    event_type = models.CharField(choices= [('Concert','Concert'), ('Weeding','Weeding')],max_length=100,null=True, blank=True)
